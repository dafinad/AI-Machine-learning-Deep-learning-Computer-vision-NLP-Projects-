...
img_path = r'C:\Users\user\Desktop\DL&ML PROJECT\ColorDetection\scenery.jpeg'
...
# calculate the distance(d) which tells us how close we are to color and choose the having minimum distance
